...
<head>
    <meta charset="UTF-8">
    <?php  
        echo "<title>High School DxD Chap ".$_GET['cid']."</title>";
    ?>
    ...
    <header>
        <div class="reading-control">
            <form action="http://sonvuhong.com/MangaReaderWeb/" method="get">
                ...
                <select name="chap" class="selectChap" id="chap" onchange="javascript:window.location.href='read.php?id=0002&cid=' + this.options[this.selectedIndex].value + '';">
                    <?php
