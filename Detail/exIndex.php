...
<head>
  <meta charset="UTF-8">
  <?php echo"<title>".$_GET['name']."</title>"; ?>
								...
								<div class="detail_info">
									...
									<div class="settingBtnBox">
										<div class="settingBtnBoxLeft">
											<?php
												echo "<a title=\"Click to read manga !\" href=\"read.php?name=".$row['Name']."&id=".$_GET['id']."&cid=1\">Read Manga<i class=\"arrowRight-w\"></i><i class=\"myMagazineFlag_off\"></i></a>";
											?>
										</div>
